<x-app-layout>
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-3 md:py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="http://source.unsplash.com/200x200/?face&crop=face&v=1" alt="avatar" class="w-14 h-14 rounded-xl">
                    </a>
                </div>
                <div class="w-full flex flex-col justify-between mx-0 md:mx-4">
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-3 md:py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-0 md:mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center md:hidden mt-4 md:mt-0">
                            <div class="bg-gray-100 text-center rounded-xl h-10 px-4 py-2 pr-8">
                                <div class="text-sm font-bold text-blue leading-none">66</div>
                                <div class="text xxs font-semibold leading-none text-gray-400">Votes</div>
                            </div>
                            <button
                                class="w-20 bg-blue text-white border border-blue hover:bg-blue-hover font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3 -mx-5"
                            >
                                Voted
                            </button>
                        </div>                        
        ...
        <div class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-3 md:py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="http://source.unsplash.com/200x200/?face&crop=face&v=5" alt="avatar" class="w-14 h-14 rounded-xl">
                    </a>
                </div>
                <div class="w-full flex flex-col justify-between mx-0 md:mx-4">
                    <h4 class="text-xl font-semibold mt-2 md:mt-0">
