<div x-data="{ isOpen: false }">
    ...
    <div 
        ...
        class="z-20 flex justify-between max-w-xs sm:max-w-sm w-11/12 sm:w-full fixed bottom-0 right-0 bg-white rounded-xl shadow-lg border px-4 py-5 mx-2 sm:mx-6 my-8"
    >
