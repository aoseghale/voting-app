...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex" style="max-width: 1000px;">
            <div class="w-70 mr-5">
                Add idea form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores expedita consequatur repellat esse saepe doloremque provident quasi libero, dolorum sequi odit ad. Repudiandae repellat molestias maxime quod vel quo inventore voluptate officiis ex alias est quos temporibus, recusandae expedita obcaecati.
            </div>
            <div class="w-175">
