<nav class="hidden md:flex items-center justify-between text-xs text-gray-400">
    ...
    <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
        ...
        <li><a wire:click.prevent="setStatus('Closed')" href="#" class="transition duration-150 ease-in border-b-4 pb-3 hover:border-blue @if ($status === 'Closed') border-blue text-gray-900 @endif">Closed (5)</a></li>
    </ul>
</nav>