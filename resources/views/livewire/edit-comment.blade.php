...
>
    <div class="flex items-end justify-center min-h-screen">
        ...
        <div
            x-show.transition.opacity.origin.bottom.duration.300ms="isOpen" 
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form wire:submit.prevent="updateComment" action="#" method="POST" class="space-y-4 px-4 py-6">
                    ...
                    <div class="flex items-center justify-between space-x-3">
                        ...
                        <button 
                            type="submit"
                            class="flex items-center justify-center w-1/2 h-11 text-sm bg-blue text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3"
                        >
                            <span>Update</span>
                        </button>                            
                    </div>
