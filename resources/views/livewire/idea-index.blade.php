        ...
        <div class="mt-8">
            @if ($hasVoted)
                <button
                    ...
                    class="w-20 bg-blue text-white border border-blue hover:border-blue-hover hover:bg-blue-hover font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3"
                >
                    Voted
                </button>
            @else
