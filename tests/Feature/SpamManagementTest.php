...
class SpamManagementTest extends TestCase
{
    ...
    /** @test */
    public function mark_as_spam_shows_on_menu_when_user_has_authorization()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function mark_as_spam_does_not_show_on_menu_when_user_does_not_have_authorization()
    {
        $idea = Idea::factory()->create();
    ...
    /** @test */
    public function shows_mark_idea_as_not_spam_livewire_component_when_user_is_admin_and_idea_has_been_marked_as_spam()
    {
    ...
    public function marking_an_idea_as_not_spam_works_when_user_has_authorization()
    {
        ...
        $this->assertEquals(4, Idea::first()->spam_reports);
    ...
    public function marking_an_idea_as_not_spam_does_not_work_when_user_does_not_have_authorization()
    {
        ...
        // Now test for idea creator (not admin)
    ...
    /** @test */
    public function mark_as_not_spam_shows_on_menu_when_user_has_authorization()
    {
        $user = User::factory()->admin()->create();
    ...
    /** @test */
    public function mark_as_not_spam_does_not_show_on_menu_when_user_does_not_have_authorization()
    {
        $idea = Idea::factory()->create([
            'spam_reports' => 4,
        ]);
