...
class DeleteIdeaTest extends TestCase
{
    ...
    /** @test */
    public function delete_idea_shows_on_menu_when_user_has_authorization()
    {
        $user = User::factory()->create();
    ...
    /** @test */
    public function delete_idea_does_not_show_on_menu_when_user_does_not_have_authorization()
    {
        $user = User::factory()->create();
